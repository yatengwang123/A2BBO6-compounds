...
"""
"loss=’squared_error’, n_estimators=100, subsample=1.0,
...
with open('GBR_score_r2.txt', 'a', encoding='utf-8') as f:
    f.write(str(grid_search.best_score_))

with open('GBR_grid_search.pickle', 'wb') as f:
    pickle.dump(grid_search, f)

joblib.dump(grid_search, 'GBR_grid_search.pkl')
with open('GBR_result.txt', 'a', encoding='utf-8') as f:
