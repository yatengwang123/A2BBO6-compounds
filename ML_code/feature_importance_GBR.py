...
my_r2_gbr = display_correlation3(t2_gbr)
...
my_r21 = display_correlation3(t2_gbr, save_pig=True, name='GBR Spearman Correlation')
...
ax0.tick_params(direction='in', axis='both', left=True, top=True, right=True, bottom=True, labelleft=True,  labeltop=False, labelright=False, labelbottom=True)
plt.savefig('GBR_feature_importance.pdf', bbox_inches='tight', pad_inches=0.05)
plt.savefig('GBR_feature_importance.png', bbox_inches='tight', pad_inches=0.05, dpi=300)
